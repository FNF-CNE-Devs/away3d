...
class FaceHelper {
	 ...
	 */
	public static function addFaces(mesh:Mesh, v0s:Vector<Vertex>, v1s:Vector<Vertex>, v2s:Vector<Vertex>, uv0s:Vector<UV>, uv1s:Vector<UV>, uv2s:Vector<UV>,
			subGeomIndices:Vector<UInt>):Void {
	...
	public static function getFaceTangent(v0:Vertex, v1:Vertex, v2:Vertex, uv0V:Float, uv1V:Float, uv2V:Float, uvScaleV:Float = 1, out:Vertex = null):Vertex {
		...
		if (tangent == null)
			tangent = new Vertex(0.0, 0.0, 0.0);
	...
	private static function updateSubGeometryData(subGeometry:SubGeometry, vertices:Vector<Float>, indices:Vector<UInt>, uvs:Vector<Float>,
			normals:Vector<Float> = null, tangents:Vector<Float> = null):Void {
