...
class MeshDebugger {
	...
	/*
		...
		*@param	displayTangents			Boolean. If true the mesh tangents are displayed.
	 */
	public function debugContainer(object:ObjectContainer3D, scene:Scene3D, displayNormals:Bool = true, displayVertexNormals:Bool = false,
			displayTangents:Bool = false):Void {
