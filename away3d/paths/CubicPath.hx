...
class CubicPath extends SegmentedPathBase implements IPath {
	...
	override private function stitchSegment(start:IPathSegment, middle:IPathSegment, end:IPathSegment):Void {
		var seg:CubicPathSegment = cast(middle, CubicPathSegment);
		var prevSeg:CubicPathSegment = cast(start, CubicPathSegment);
		var nextSeg:CubicPathSegment = cast(end, CubicPathSegment);
