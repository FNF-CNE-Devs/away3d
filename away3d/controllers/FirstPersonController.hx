...
class FirstPersonController extends ControllerBase {
	 ...
	 */
	public function new(targetObject:Entity = null, panAngle:Float = 0, tiltAngle:Float = 90, minTiltAngle:Float = -90, maxTiltAngle:Float = 90,
			steps:Int = 8, wrapPanAngle:Bool = false) {
		super(targetObject);
