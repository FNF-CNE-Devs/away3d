...
class TripleFilteredShadowMapMethod extends SimpleShadowMapMethodBase {
	...
	public function new(castingLight:DirectionalLight) {
		super(castingLight);
		if (#if (haxe_ver >= 4.2) Std.isOfType #else Std.is #end (castingLight, PointLight))
	...
	override private function getPlanarFragmentCode(vo:MethodVO, regCache:ShaderRegisterCache, targetReg:ShaderRegisterElement):String {
		...
		code = "mov " + uvReg + ", " + _depthMapCoordReg + "\n" + "tex " + depthCol + ", " + uvReg + ", " + depthMapRegister + " <2d, nearest, clamp>\n"
			...
			+ uvReg + ".w, " + uvReg + ".w, " + uvReg + ".z		\n" + "mul " + uvReg + ".w, " + uvReg + ".w, " + depthCol + ".x		\n" + "add " + viewDirReg
			+ ".w, " + uvReg + ".z, " + uvReg + ".w		\n" + "sub " + uvReg + ".x, " + _depthMapCoordReg + ".x, " + customDataReg + ".z	\n" + "add " + uvReg

			+ ".y, " + _depthMapCoordReg + ".y, " + customDataReg + ".z	\n" + // (0, 1)
			"tex " + depthCol + ", " + uvReg + ", " + depthMapRegister + " <2d, nearest, clamp>\n" + "dp4 " + depthCol + ".z, " + depthCol + ", " + decReg
			+ "\n" + "slt " + uvReg + ".z, " + _depthMapCoordReg + ".z, " + depthCol + ".z		\n" + // 0 if in shadow
			...
			"div " + depthCol + ".x, " + _depthMapCoordReg + ".x, " + customDataReg + ".z		\n" + "frc " + depthCol + ".x, " + depthCol + ".x								\n"
			+ "sub " + uvReg + ".w, " + uvReg + ".w, " + uvReg + ".z					\n" + "mul " + uvReg + ".w, " + uvReg + ".w, " + depthCol + ".x					\n" + "add "
			+ viewDirReg + ".w, " + uvReg + ".z, " + uvReg + ".w	\n" + "mov " + uvReg + ".x, " + _depthMapCoordReg + ".x							\n" + "add " + uvReg + ".y, "

			+ uvReg + ".y, " + customDataReg + ".z				\n" + // (0, 1)
			"tex " + depthCol + ", " + uvReg + ", " + depthMapRegister + " <2d, nearest, clamp>\n" + "dp4 " + depthCol + ".z, " + depthCol + ", " + decReg
