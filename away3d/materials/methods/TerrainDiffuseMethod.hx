...
class TerrainDiffuseMethod extends BasicDiffuseMethod {
	 ...
	 */
	private function getSplatSampleCode(vo:MethodVO, targetReg:ShaderRegisterElement, inputReg:ShaderRegisterElement, texture:TextureProxyBase,
			uvReg:ShaderRegisterElement = null):String {
		if (uvReg == null)
