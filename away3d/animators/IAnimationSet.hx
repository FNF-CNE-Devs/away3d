...
interface IAnimationSet {
	 ...
	 */
	private function cancelGPUCompatibility():Void;
	 ...
	 */
	private function getAGALVertexCode(pass:MaterialPassBase, sourceRegisters:Vector<String>, targetRegisters:Vector<String>, profile:String):String;
	 ...
	 * @return The AGAL Vertex code that animates the vertex data.
	 */
	private function getAGALFragmentCode(pass:MaterialPassBase, shadedTarget:String, profile:String):String;
	 ...
	 */
	private function getAGALUVCode(pass:MaterialPassBase, UVSource:String, UVTarget:String):String;
	 ...
	 */
	private function doneAGALCode(pass:MaterialPassBase):Void;
	 ...
	 * @param pass The material pass currently being used to render the geometry.
	 */
	private function activate(stage3DProxy:Stage3DProxy, pass:MaterialPassBase):Void;
	 ...
	 * @param pass The material pass currently being used to render the geometry.
	 */
	private function deactivate(stage3DProxy:Stage3DProxy, pass:MaterialPassBase):Void;
}
