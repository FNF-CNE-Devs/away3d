...
class ParticleSpriteSheetNode extends ParticleNodeBase {
	 ...
	 */
	public function new(mode:ParticlePropertiesMode, usesCycle:Bool, usesPhase:Bool, numColumns:Int = 1, numRows:Int = 1, cycleDuration:Float = 1,
			cyclePhase:Float = 0, totalFrames:Int = -1) {
