...
class ParticleUVNode extends ParticleNodeBase {
	...
	private inline function set_axis(value:String):String {
		return _axis = value;
	}
	...
	override public function getAGALUVCode(pass:MaterialPassBase, animationRegisterCache:AnimationRegisterCache):String {
		...
		if (animationRegisterCache.needUVAnimation) {
			...
			var target:ShaderRegisterElement = new ShaderRegisterElement(animationRegisterCache.uvTarget.regName, animationRegisterCache.uvTarget.index,
				axisIndex);
